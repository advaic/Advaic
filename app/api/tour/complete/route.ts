// app/api/tour/complete/route.ts
...
export async function POST(req: NextRequest) {
  ...
  const final_step = body.final_step
    ? Math.max(1, Number(body.final_step))
    : null;
    ...
    .upsert(
      {
        ...
        tour_key,
        status: "completed",
        ...(final_step ? { current_step: final_step } : {}),
