...
export default function KontoUebersichtPage() {
  return (
    <div className="space-y-8" data-tour="account-page">
      <div>
        <h1 className="text-2xl font-bold" data-tour="account-header">Konto-Übersicht</h1>
        <p className="text-muted-foreground text-sm">
          Hier findest du alle wichtigen Informationen zu deinem Konto.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-4" data-tour="account-overview-cards">
      ...
      <div className="space-y-4" data-tour="account-actions">
        <Link href="/abo" data-tour="account-change-plan">
          <Button variant="secondary">Plan ändern</Button>
        </Link>
        <Link href="/daten" data-tour="account-personal-data">
          <Button variant="outline">Persönliche Daten anzeigen</Button>
        </Link>
        <Link href="/konto-loeschen" data-tour="account-delete">
